...
const addTechClassToFirstLi = (event) => {
  event.target.classList.add('tech')
  secondLi.classList.remove('tech')
  thirdLi.classList.remove('tech')
}
const addTechClassToSecondtLi = (event) => {
  event.target.classList.add('tech')
  firstLi.classList.remove('tech')
  thirdLi.classList.remove('tech')
}
const addTechClassToThirdLi = (event) => {
  event.target.classList.add('tech')
  secondLi.classList.remove('tech')
  firstLi.classList.remove('tech')
}

firstLi.addEventListener('click', addTechClassToFirstLi)
secondLi.addEventListener('click', addTechClassToSecondtLi)
thirdLi.addEventListener('click', addTechClassToThirdLi)
...
const redirect = () => window.open('https://claushaas.dev', '_blank')
